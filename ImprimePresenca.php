...
$sql = "SELECT *,DATE_FORMAT(datacad,'%d/%m/%Y') as idatacad, DATE_FORMAT(nascimento,'%d/%m/%Y') as inasc FROM cadCR WHERE ano = '$ano' ORDER BY presenca desc, nome asc";
...
$dados[] = array('<b>Nº</b>'=>$cont,'<b>Nome</b>'=>$nome,'<b>Nascimento</b>'=>$nasc,'<b>Idade</b>'=>$old,'<b>Telefone</b>'=>$tel,'<b>Celular</b>'=>$cel,'<b>Email</b>'=>$email,'<b>Presenca</b>'=>$presenca,'<b>Faltas</b>'=>$falta);
$cont = $cont + 1;
}
$pdf->ezTable($dados,'','',array('xPos'=>50,'xOrientation'=>'right','fontSize' => 8,'width'=>750,'cols'=>array('Nun'=>array('width'=>50),'Nome'=>array('width'=>50),'Nascimento'=>array('width'=>50),'Idade'=>array('width'=>50),'Telefone'=>array('width'=>50),'Celular'=>array('width'=>50),'Email'=>array('width'=>50),'Presenca'=>array('width'=>30),'Faltas'=>array('width'=>30))));
