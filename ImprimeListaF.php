...
$pdf->ezText("<b>Celebrando a Recuperação</b>",14,array('justification'=>'center'));// Define o texto do seu pdf, e o tamanho da fonte;
...
$sql = "SELECT *,DATE_FORMAT(datacad,'%d/%m/%Y') as idatacad, DATE_FORMAT(nascimento,'%d/%m/%Y') as inasc FROM cadCR WHERE ano = '$ano' and sexo = 'Feminino' ORDER BY nome,memb asc";
